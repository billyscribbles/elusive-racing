  ...
  return (
    <header className="adm-header" data-admin-theme={theme}>
      <div className="adm-header-left">
        <Link to="/" className="adm-logo-link" aria-label="Back to homepage">
        ...
        <nav className="adm-nav">
          ...
          <NavLink to="/admin/orders" className={({ isActive }) => `adm-nav-link${isActive ? ' adm-nav-link--active' : ''}`}>Orders</NavLink>
          <NavLink to="/admin/users" className={({ isActive }) => `adm-nav-link${isActive ? ' adm-nav-link--active' : ''}`}>Users</NavLink>
